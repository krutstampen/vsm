 ...
 *       &lt;sequence>
 *         &lt;element name="product-id" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "firmware-update-request")
public class FirmwareUpdateRequest {
    ...
    protected FirmwareUpdateRequest.Units units;
     ...
     * @return
     *     possible object is
     *     {@link FirmwareUpdateRequest.Units }
     *     
     */
    public FirmwareUpdateRequest.Units getUnits() {
        return units;
    }
     ...
     *     
     */
    public void setUnits(FirmwareUpdateRequest.Units value) {
        this.units = value;
    }
    ...
    public static class Units {
        ...
        protected List<FirmwareUpdateRequest.Units.Unit> unit;
         ...
         * {@link FirmwareUpdateRequest.Units.Unit }
         * 
         * 
         */
        public List<FirmwareUpdateRequest.Units.Unit> getUnit() {
            if (unit == null) {
                unit = new ArrayList<FirmwareUpdateRequest.Units.Unit>();
            }
            return this.unit;
        }
